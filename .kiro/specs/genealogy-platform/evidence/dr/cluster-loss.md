# DR Drill Evidence — Cluster Loss
...
| Field | Value |
| ----- | ----- |
| Drill kind | `cluster_loss` |
| Cadence | 90 days |
| Blast radius | `per_cluster` |
| Primary region | `gp-region-primary` |
| Allowed DR | `gp-region-secondary-a`, `gp-region-secondary-b` |
| Reconcile targets | `outbox_relay`, `kafka_consumer`, `temporal_workflow`, `search_projection`, `public_projection`, `audit_pipeline`, `flagsmith_cache` |
