...
service. Shared library ch� dành cho cross-cutting ổn định như
...
See `platform-telemetry/README.md` for the OTel bootstrap, redaction
processor, logback JSON encoder and metric defaults.
