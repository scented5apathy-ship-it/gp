/**
 * scripts/__tests__/lint-dna-revoke.test.mjs
 *
 * Unit tests for `scripts/lint-dna-revoke.mjs`.
 */
...
const SCRIPT = "scripts/lint-dna-revoke.mjs";
...
describe("lint-dna-revoke", () => {
  let tmpDir;

  before(() => {
    tmpDir = mkdtempSync(join(tmpdir(), "lint-dna-revoke-"));
  });
  ...
  it("passes when the canonical contract is valid", () => {
    ...
    if (!result.stdout.includes("E10.5 DNA revoke / export / delete policy contract OK")) {
