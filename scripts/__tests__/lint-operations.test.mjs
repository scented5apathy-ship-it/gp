/**
 * scripts/__tests__/lint-operations.test.mjs
 *
 * Unit tests for `scripts/lint-operations.mjs`.
...
const SCRIPT = "scripts/lint-operations.mjs";
...
describe("lint-operations", () => {
  let tmpDir;
  before(() => {
    tmpDir = mkdtempSync(join(tmpdir(), "lint-ops-"));
  });
  after(() => {
  ...
  it("passes when the canonical contract is valid", () => {
    ...
    if (!result.stdout.includes("E11.5 Admin / support operations contract OK")) {
