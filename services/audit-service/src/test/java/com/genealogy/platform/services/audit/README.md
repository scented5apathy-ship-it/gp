# services/audit-service/src/test/java/com/genealogy/platform/services/audit

Canonical unit + contract tests for the **AuditEntry / AuditExport** service.
...
- `UauditServiceSkeletonTest.java`
