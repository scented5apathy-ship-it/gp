# services/collaboration-service/src/main/java/com/genealogy/platform/services/collaboration

Canonical production code for the **ChangeProposal / Review / Comment / ActivityFeed** service.
