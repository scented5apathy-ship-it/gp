package com.genealogy.platform.services.collaboration;
...
/**
 * Cross-service boundary guard for {@code collaboration-service}.
 *
 ...
 */
@AnalyzeClasses(
    packages = "com.genealogy.platform.services.collaboration",
...
class ServiceBoundaryTest {
    ...
    static final ArchRule SERVICES_MUST_NOT_IMPORT_OTHER_SERVICES_DB =
        ArchRuleDefinition.noClasses()
            .that().resideInAPackage("com.genealogy.platform.services.collaboration..")
