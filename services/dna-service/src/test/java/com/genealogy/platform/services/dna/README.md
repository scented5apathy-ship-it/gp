# services/dna-service/src/test/java/com/genealogy/platform/services/dna

Canonical unit + contract tests for the **DnaKit / Consent / DnaMatch / Segment** service.
