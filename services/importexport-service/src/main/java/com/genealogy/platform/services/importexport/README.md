# services/importexport-service/src/main/java/com/genealogy/platform/services/importexport

Canonical production code for the **TransferJob / MappingProfile / ExportManifest** service.
