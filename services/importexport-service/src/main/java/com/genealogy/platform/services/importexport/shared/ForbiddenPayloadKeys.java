...
/**
 * Forbidden payload patterns the import/export pipeline MUST refuse.
 * Mirrors <code>forbiddenPayloadPatterns</code> across E9.1 — E9.6.
 ...
 * aggregate references (per ADR-E0.5-08 + design.md §5.1).
 */
public final class ForbiddenPayloadKeys {
