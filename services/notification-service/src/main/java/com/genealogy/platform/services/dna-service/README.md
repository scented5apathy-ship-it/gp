# services/notification-service → dna-service

Cross-service package marker. The `com.genealogy.platform.services.dna-service`
...
- No file under `services/notification-service/` may import another service's
  ...
  package — including the `dna-service` package.
...
Owner of the `dna-service` package: see `services/dna-service/OWNERS`.
