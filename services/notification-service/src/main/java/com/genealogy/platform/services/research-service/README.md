# services/notification-service → research-service

Cross-service package marker. The `com.genealogy.platform.services.research-service`
...
- No file under `services/notification-service/` may import another service's
  ...
  package — including the `research-service` package.
...
Owner of the `research-service` package: see `services/research-service/OWNERS`.
