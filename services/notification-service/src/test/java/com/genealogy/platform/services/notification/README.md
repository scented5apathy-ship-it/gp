# services/notification-service/src/test/java/com/genealogy/platform/services/notification

Canonical unit + contract tests for the **Notification / Preference / Template** service.
...
- `UnotificationServiceSkeletonTest.java`
