# services/notification-service → reporting-service

Cross-service package marker. The `com.genealogy.platform.services.reporting-service`
...
- No file under `services/notification-service/` may import another service's
  ...
  package — including the `reporting-service` package.
...
Owner of the `reporting-service` package: see `services/reporting-service/OWNERS`.
