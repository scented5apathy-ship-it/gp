# services/reporting-service/src/test/java/com/genealogy/platform/services/reporting

Canonical unit + contract tests for the **ReportJob / ReportTemplate / AnalyticsProjection** service.
...
- `UreportingServiceSkeletonTest.java`
