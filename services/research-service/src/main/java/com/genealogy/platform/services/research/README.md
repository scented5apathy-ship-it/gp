# services/research-service/src/main/java/com/genealogy/platform/services/research

Canonical production code for the **Source / Citation / ResearchTask / Hypothesis** service.
