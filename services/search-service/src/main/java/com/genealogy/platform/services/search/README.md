# services/search-service/src/main/java/com/genealogy/platform/services/search

Canonical production code for the **SearchDocument / SavedSearch / PublicProjection** service.
