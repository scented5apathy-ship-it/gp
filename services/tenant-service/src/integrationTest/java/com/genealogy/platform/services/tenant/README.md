# services/tenant-service/src/integrationTest/java/com/genealogy/platform/services/tenant

Canonical integration tests for the **Tenant / Membership / Invitation / Entitlement** service.
...
- `InMemoryRegistry.java`
- `TenantServiceApplicationIT.java`
- `WireMockRunner.java`
