# services/tenant-service/src/test/java/com/genealogy/platform/services/tenant

Canonical unit + contract tests for the **Tenant / Membership / Invitation / Entitlement** service.
...
- `ContractInvariantsTest.java`
- `InMemoryDynamicPropertyRegistry.java`
- `ServiceBoundaryTest.java`
- `TenantServiceSkeletonTest.java`
